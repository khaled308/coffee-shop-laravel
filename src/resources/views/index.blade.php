	...
	<section class="ftco-intro">
		<div class="container-wrap">
			<div class="wrap d-md-flex align-items-xl-end">
				...
				<div class="book p-4">
					<h3>Book a Table</h3>
					<form action="{{route('booking.store')}}" class="appointment-form" method="POST">
						@csrf
						<div class="d-md-flex">
		...
		<div class="container">
			...
			<div class="row">
				@foreach ($featuredProducts as $product)	
					<div class="col-md-3">
						<div class="menu-entry">
								<a href="{{route('product.getByName', $product->slug)}}" class="img" style="background-image: url({{$product->image}});"></a>
